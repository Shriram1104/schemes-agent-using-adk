...
class MasterAgent:
    ...
    def _generate_conversational_intro(self, query: str, category_type: str) -> str:
        ...
        if any(word in query_lower for word in ['loan', 'credit', 'borrow', 'finance']):
            intros = [
                "I've found some financial assistance schemes that might help you with loans and credit! 💰",
            ...
            intros = [
                ...
                "I've got some great subsidy schemes for you! ✨",
            ]
            ...
            intros = [
                ...
                "I've got some great schemes for equipment and machinery! 🚜",
            ]
